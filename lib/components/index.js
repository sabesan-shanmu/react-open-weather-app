...
import {CheckApiIsRunning} from '../services/API'; 
...
const checkApiIsRunning = async()=>{
    const result = await CheckApiIsRunning.get();
    return result;
}
...
const App = () => {
    ...
    useEffect(()=>{
        loadMaps();
        //added in case heroku dyno goes to sleep. 
        checkApiIsRunning();
    },[])
        ...
        <AppBar position="fixed" className={classes.header}>
            <Toolbar className={classes.toolbar} >
                ...
                <div className={classes.rightToolbar}>
                    ...
                    &#32;
                    <IconButton onClick={() => { location.href="https://linkedin.com/in/sabesan-shanmugabhavananthan" }} >
                        <LinkedInIcon />  
                    </IconButton>
                </div> 
            </Toolbar>
